...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『鬼脚本』"; Text ="核对用户ID中♧"; Duration = 2; })
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『鬼脚本』"; Text ="用户ID核对完毕"; Duration = 4; })

local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/dingding123hhh/hun/main/jmlibrary1.lua"))();        --gui
local win = ui:new("扒")
--
local UITab1 = win:Tab("『信息』",'7734068321')

local about = UITab1:section("『作者：跳鬼』",false)

about:Label("有问题加2038765288"）
about:Label("脚本持续更新中")
about:Label("脚本疯狂优化中")
...
local UITab2 = win:Tab("『惊喜』",'7734068321')

local about = UITab2:section("『惊喜』",true)
